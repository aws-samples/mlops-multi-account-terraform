...
if __name__ == "__main__":
    ...
    train_data_path = args.input_data_path + "/" + model_fine_tuning_config["train_data_path"]
    ...
    training_job_name = step(finetune, name="finetune", keep_alive_period_in_seconds=2400)(
        model_id,
        endpoint_name,
        train_data_path,
        validation_data_path,
